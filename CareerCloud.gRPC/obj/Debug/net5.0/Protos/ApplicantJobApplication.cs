...
namespace CareerCloud.gRPC.Protos {
    ...
    static ApplicantJobApplicationReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ckNsb3VkLmdSUEMaG2dvb2dsZS9wcm90b2J1Zi9FbXB0eS5wcm90bxofZ29v",
            "Z2xlL3Byb3RvYnVmL3RpbWVzdGFtcC5wcm90byIYCgpJZFJlcXVlc3QxEgoK",
            "AklkGAEgASgJInoKF0FwcGxpY2FudEpvYkFwcGxpY2F0aW9uEgoKAklkGAEg",
            "ASgJEhEKCUFwcGxpY2FudBgCIAEoCRILCgNKb2IYAyABKAkSMwoPQXBwbGlj",
            "YXRpb25EYXRlGAQgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcCJY",
            "ChhBcHBsaWNhbnRKb2JBcHBsaWNhdGlvbnMSPAoJQXBwSm9iRWR1GAEgAygL",
            "MikuQ2FyZWVyQ2xvdWQuZ1JQQy5BcHBsaWNhbnRKb2JBcHBsaWNhdGlvbjK2",
            "AwoeQXBwbGljYW50Sm9iQXBwbGljYXRpb25TZXJ2aWNlEmUKGkdldEFwcGxp",
            "Y2FudEpvYkFwcGxpY2F0aW9uEhwuQ2FyZWVyQ2xvdWQuZ1JQQy5JZFJlcXVl",
            "c3QxGikuQ2FyZWVyQ2xvdWQuZ1JQQy5BcHBsaWNhbnRKb2JBcHBsaWNhdGlv",
            "bhJjCh1DcmVhdGVBcHBsaWNhbnRKb2JBcHBsaWNhdGlvbhIqLkNhcmVlckNs",
            ...
            "Fi5nb29nbGUucHJvdG9idWYuRW1wdHkSYwodVXBkYXRlQXBwbGljYW50Sm9i",
            "QXBwbGljYXRpb24SKi5DYXJlZXJDbG91ZC5nUlBDLkFwcGxpY2FudEpvYkFw",
            "cGxpY2F0aW9ucxoWLmdvb2dsZS5wcm90b2J1Zi5FbXB0eUIaqgIXQ2FyZWVy",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::CareerCloud.gRPC.Protos.ApplicantJobApplications), global::CareerCloud.gRPC.Protos.ApplicantJobApplications.Parser, new[]{ "AppJobEdu" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ApplicantJobApplications(ApplicantJobApplications other) : this() {
      appJobEdu_ = other.appJobEdu_.Clone();
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "AppJobEdu" field.</summary>
    public const int AppJobEduFieldNumber = 1;
    private static readonly pb::FieldCodec<global::CareerCloud.gRPC.Protos.ApplicantJobApplication> _repeated_appJobEdu_codec
        = pb::FieldCodec.ForMessage(10, global::CareerCloud.gRPC.Protos.ApplicantJobApplication.Parser);
    private readonly pbc::RepeatedField<global::CareerCloud.gRPC.Protos.ApplicantJobApplication> appJobEdu_ = new pbc::RepeatedField<global::CareerCloud.gRPC.Protos.ApplicantJobApplication>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::CareerCloud.gRPC.Protos.ApplicantJobApplication> AppJobEdu {
      get { return appJobEdu_; }
    }
    ...
    public bool Equals(ApplicantJobApplications other) {
      ...
      if(!appJobEdu_.Equals(other.appJobEdu_)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      output.WriteRawMessage(this);
    #else
      appJobEdu_.WriteTo(output, _repeated_appJobEdu_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    #endif
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      appJobEdu_.WriteTo(ref output, _repeated_appJobEdu_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    public int CalculateSize() {
      int size = 0;
      size += appJobEdu_.CalculateSize(_repeated_appJobEdu_codec);
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
      return size;
    ...
    public void MergeFrom(ApplicantJobApplications other) {
      ...
      appJobEdu_.Add(other.appJobEdu_);
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            appJobEdu_.AddEntriesFrom(input, _repeated_appJobEdu_codec);
            break;
          }
        }
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            appJobEdu_.AddEntriesFrom(ref input, _repeated_appJobEdu_codec);
            break;
          }
        }
      }
