  ...
  public  class CompanyJobDescriptionLogic:BaseLogic<CompanyJobDescriptionPoco>
    {
        ...
        protected override void Verify(CompanyJobDescriptionPoco[] pocos)
        {
            ...
            foreach (CompanyJobDescriptionPoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(300, "The Job Name must have value which is not null"));
                }
                if (string.IsNullOrEmpty(poco.JobDescriptions))
                {
                    exceptions.Add(new ValidationException(301, "The Job Description must have value which is not null"));
                }
